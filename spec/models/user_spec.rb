...
RSpec.describe User, type: :model do
  before(:each) do
    @user = User.new(name: 'Anyone', email: 'email@blog.com', password: 'password', confirmed_at: Time.now)
  end
...
describe 'Tests with new user' do
  before(:each) do
    @new_user = User.create(name: 'Anyone else', email: 'other@blog.com', password: 'password', confirmed_at: Time.now)
  end
